...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Dragable = _react2['default'].createClass({
	    ...
	    bindEvent: function bindEvent() {
	        ...
	        if (!!('ontouchstart' in window)) {
	            (0, _utils.on)(document, 'touchmove', this.__touchMoveHandler);
	            (0, _utils.on)(document, 'touchend', this.__touchEndOrCancelHandler);
	            (0, _utils.on)(document, 'touchcancel', this.__touchEndOrCancelHandler);
	        } else {
	            (0, _utils.on)(document, 'mousemove', this.__mouseMoveHandler);
	            (0, _utils.on)(document, 'mouseup', this.__mouseUpHandler);
	        }
	    },
	    unbindEvent: function unbindEvent() {
	        if (!!('ontouchstart' in window)) {
	            (0, _utils.off)(document, 'touchmove', this.__touchMoveHandler);
	            (0, _utils.off)(document, 'touchend', this.__touchEndOrCancelHandler);
	            (0, _utils.off)(document, 'touchcancel', this.__touchEndOrCancelHandler);
	        } else {
	            (0, _utils.off)(document, 'mousemove', this.__mouseMoveHandler);
	            (0, _utils.off)(document, 'mouseup', this.__mouseUpHandler);
	        }
	    ...
	    calculateNewIndex: function calculateNewIndex(e) {
	        ...
	        var target = (0, _utils.get)('.ui-dragable-dragging') || (0, _utils.closest)(e.target || e.srcElement, '.ui-dragable-item');
	    ...
	    getDragData: function getDragData() {
	        ...
	        return this._orderArr.map(function (itemidx, index) {
	            var item = Array.isArray(_this2.props.children) ? _this2.props.children[itemidx] : _this2.props.children;
	            if (!item) {
	                return undefined;
	            }
	    ...
	    renderItems: function renderItems() {
	        ...
	        var items = _orderArr.map(function (itemIndex, index) {
	            ...
	            var itemClassName = 'ui-dragable-item ' + (isPlaceHolder && 'ui-dragable-placeholder') + ' ' + (_this3.state.isDragging && isPlaceHolder && 'visible');

	            return _react2['default'].cloneElement(item, {
	                key: index,
	                dragableClassName: item.props.className + ' ' + itemClassName,
	                dragableIndex: index,
	                onDragableItemReadyToMove: isPlaceHolder ? undefined : function (e) {
	                    _this3.handleMouseDown.call(_this3, e, index);
	                },
	                onDragableItemMount: _this3.handleChildUpdate
	            });
	        });
	    ...
	    render: function render() {
	        var className = 'ui-dragable ' + (this.props.className || '');

	        return _react2['default'].createElement('div', { className: className }, ' ', this.renderItems(), ' ');
	    }
	});

	Dragable.DragableItemMixin = (0, _DragableItemMixin2['default'])();
	Dragable.dragable = _DragableItemMixin2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defaultProps = {
	    dragableClassName: '',
	    dragableStyle: {},
	    onDragableItemMount: function onDragableItemMount() {},
	    onDragableItemReadyToMove: function onDragableItemReadyToMove() {}
	};

	exports['default'] = function (Component) {
	    if (Component) {
	        return (function (_React$Component) {
	            _inherits(DragableItem, _React$Component);

	            function DragableItem() {
	                _classCallCheck(this, DragableItem);

	                _get(Object.getPrototypeOf(DragableItem.prototype), 'constructor', this).apply(this, arguments);
	            }

	            _createClass(DragableItem, [{
	                key: 'handleDragableItemReadyToMove',
	                value: function handleDragableItemReadyToMove(e) {
	                    _handleDragableItemReadyToMove.call(this, e);
	                }
	            }, {
	                ...
	                value: function render() {
	                    ...
	                    var dragableClassName = _props.dragableClassName;
	                    var dragableStyle = _props.dragableStyle;
	                    var dragableIndex = _props.dragableIndex;

	                    var rest = _objectWithoutProperties(_props, ['dragableClassName', 'dragableStyle', 'dragableIndex']);

	                    return _react2['default'].createElement(Component, _extends({}, rest, { className: dragableClassName, style: dragableStyle, key: dragableIndex,
	    ...
	    return {
	        ...
	        handleDragableItemReadyToMove: _handleDragableItemReadyToMove,

	        componentDidMount: handleComponentDidMount,

	        componentDidUpdate: handleComponentDidUpdate,

	        renderWithDragable: function renderWithDragable(item) {
	            return _react2['default'].cloneElement(item, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  mixins: [_dragableIndexJs.DragableItemMixin],
	  getDefaultProps: function getDefaultProps() {
	    return {
	      className: 'img-item'
	    };
	  ...
	  render: function render() {
	    return this.renderWithDragable(_react2['default'].createElement('img', { draggable: false, src: this.props.src, className: this.props.className }));
	  }
	});
	module.exports = exports['default'];
