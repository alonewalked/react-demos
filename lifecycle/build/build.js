...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/tangjing/Documents/react/react-demos/lifecycle/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/tangjing/Documents/react/react-demos/lifecycle/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var App = _react2['default'].createClass({
	    ...
	    render: function render() {
	        return _react2['default'].createElement('div', null, _react2['default'].createElement('span', null, 'life cycle demo'), _react2['default'].createElement(_hello2['default'], { name: '1', delay: '300', stop: this.state.stop }), _react2['default'].createElement('button', { onClick: this._doclick }, this.state.buttonName));
	    },
	    _doclick: function _doclick() {
	        this.state.stop ? this.setState({
	            stop: false,
	            buttonName: '暂停'
	        }) : this.setState({
	            stop: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelloWord = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2['default'].createElement('p', null, _react2['default'].createElement('span', null, 'hello ', this.props.name, ' '), _react2['default'].createElement('span', null, this.state.times));
	    },
	    add: function add(isContinue) {
	        var _this = this;
	        ...
	        this.timer = setTimeout(function () {
	            var _time = _this.state.times;
	            _this.setState({
	                times: ++_time
	            });
	            if (_this.state.times < 100) {
	                _this.add(_this.state['continue']);
	            }
	        }, this.props.delay);
	    }
	});
