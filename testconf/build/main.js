...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/tangjing/baidu/iqiyi/dragon/testconf/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/tangjing/baidu/iqiyi/dragon/testconf/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var ChildComponent = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement('div', null, _react2['default'].createElement('p', null, 'type: ', this.props.type, ' >> ', this.props.number), _react2['default'].createElement('a', { onClick: this.props.onClickHandler }, 'self click'), _react2['default'].createElement('hr', null));
	  }
	});
	...
	var App = _react2['default'].createClass({
	  ...
	  _renderToString: function _renderToString() {
	    return _react2['default'].renderToString(_react2['default'].createElement(ChildComponent, {
	      type: 'renderToString',
	      number: this.state.number,
	      onClickHandler: this._clickHandler }));
	  },
	  _renderToStaticMarkup: function _renderToStaticMarkup() {
	    return _react2['default'].renderToStaticMarkup(_react2['default'].createElement(ChildComponent, {
	  ...
	  render: function render() {
	    return _react2['default'].createElement('div', null, _react2['default'].createElement(ChildComponent, {
	      type: 'render',
	      number: this.state.number,
	      onClickHandler: this._clickHandler }), _react2['default'].createElement('div', { dangerouslySetInnerHTML: { __html: this._renderToString() } }), _react2['default'].createElement('div', { dangerouslySetInnerHTML: { __html: this._renderToStaticMarkup() } }), _react2['default'].createElement('div', null, _react2['default'].createElement('a', { onClick: this._clickHandler }, 'click')));
	  }
	
	});
	_react2['default'].render(_react2['default'].createElement(App, null), document.getElementById('app'));
	
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/tangjing/baidu/iqiyi/dragon/testconf/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "main.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
